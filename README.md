...
Репозиторий с Jupyter-ноутбуками по классическому машинному обучению. Работы собраны вокруг практики: подготовка данных, признаки, обучение моделей, проверка качества, визуализация и разбор результатов.

Ноутбуки идут в порядке домашних работ, но каждый можно читать отдельно — как небольшой кейс с конкретной задачей, экспериментами и выводами.
...
- сравнение моделей на одинаковой постановке задачи, включая сравнение K-Means и DBSCAN для кластеризации;
- построение пайплайнов с масштабированием признаков и анализ влияния масштаба на расстояния;
